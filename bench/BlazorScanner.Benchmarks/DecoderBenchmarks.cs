...
public class DecoderBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _frames["DataMatrix"] = FrameFactory.DataMatrix("BLAZORSCANNER-DM-2026");
        _frames["Code128"] = FrameFactory.Linear(
            "Code 128", BarcodeFormat.Code128, LinearEncoders.Code128("BLAZOR-SCANNER-128"), "BLAZOR-SCANNER-128");
