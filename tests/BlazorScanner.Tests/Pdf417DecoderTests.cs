...
/// <see cref="BlazorScanner.Pipeline.BarcodeDecoder"/> until a specification table is registered.
/// </remarks>
public class Pdf417DecoderTests
{
    ...
    public void DecodesFromARenderedAndBinarisedImage()
    {
        ...
        using var binary = new BlazorScanner.Imaging.HybridBinarizer().GetBlackMatrix(image.View);
    ...
    {
        using var decoder = new BlazorScanner.Pipeline.BarcodeDecoder(new ScannerOptions
        {
