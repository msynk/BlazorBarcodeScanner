...
public static class SampleCatalog
{
    ...
    [
        new(BarcodeFormat.QrCode, "QR Code", "https://github.com/blazor-scanner",
            QrEncoder.Encode("https://github.com/blazor-scanner", QrErrorCorrectionLevel.M, maskPattern: 2), null),
        ...
        new(BarcodeFormat.DataMatrix, "Data Matrix", "BLAZORSCANNER-DM",
            DataMatrixEncoder.Encode("BLAZORSCANNER-DM"), null),

        new(BarcodeFormat.DataMatrix, "Data Matrix (numeric)", "20260905123456",
            DataMatrixEncoder.Encode("20260905123456"), null),

        new(BarcodeFormat.Code128, "Code 128", "BLAZOR-SCANNER-128",
            null, LinearEncoders.Code128("BLAZOR-SCANNER-128")),
