...
public static class Verification
{
    ...
    public static void Run()
    {
        var frames = new List<FrameFactory.Frame>
        {
            ...
            FrameFactory.DataMatrix("BLAZORBARCODESCANNER-DM-2026"),
            FrameFactory.Linear("Code 128", BarcodeFormat.Code128, LinearEncoders.Code128("BARCODE-SCANNER-128"), "BARCODE-SCANNER-128"),
